...
class MovieReport {
    ...
    public String toString(){
        return "Movie: "+this.movie.getTitle()+", Score: "+Math.round(this.score*10)/10.0+", Category: "+this.category;
    }
}
...
class MovieAnalyzerImpl implements MovieAnalyzer {
    ...
    public MovieReport analyze(Movie movie) {
        ...
        return new MovieReport(movie, score, cat); // replace with your logic
    }
}
